...
public class DocprofileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String user_email= sharedPreferences.getString("d_email", "");
        String u_fname= sharedPreferences.getString("d_firstname", "");
        doc_id=sharedPreferences.getString("d_id", "");
//        String c_i_add= sharedPreferences.getString("c_i_add", "");
        String c_i_con_num= sharedPreferences.getString("d_contact_info", "");
        String c_gender= sharedPreferences.getString("d_gender", "");
        String status= sharedPreferences.getString("u_status", "");

        String u_lname= sharedPreferences.getString("d_lastname", "");
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        bt_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.clear();
                editor.commit();
                Intent i=new Intent(DocprofileActivity.this, ChoiceActivity.class);
                startActivity(i);
                finish();
            }
        });
