...
import com.diabites.doctor.UserDetailActivity;
...
public class UserListAdapter extends RecyclerView.Adapter<UserListAdapter.myViewHolder> {
    ...
    public UserListAdapter(FragmentActivity activity, List<userlogin> postList) {
...
String url=Imageurl+docdata.get(position).getU_pic();
        ...
        {
            holder.bt_request.setText("More");
...
i.putExtra("cname",docdata.get(position).getU_fname()+docdata.get(position).getU_lname());
i.putExtra("cmobile",docdata.get(position).getU_phone_no());
i.putExtra("cemail",docdata.get(position).getU_email());
i.putExtra("cid",docdata.get(position).getU_id());
                    i.putExtra("cpic",url);
